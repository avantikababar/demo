...
// var _myName = "shahid";
// var 1myName = "khan";
// var _1my__Name = "mr.shahidpathan";
// console.log(_1my__Name);
// // var $myName = "shahid khan";
// var myNaem% = "shahid pathan";
...
// var myPhoneNumber = 8457834578;
// var mySecondNum = "jdfgjf";



// if(isNaN(mySecondNum)){
...
// console.log(a===b); // value + datatype 
// console.log(a!=b);
...
// if(city=="satara"){
//   console.log("city is matched :" , city);
//   if(education =="hsc"){
//     console.log("education is matched");
//     if(isRegular==true){
//       console.log("ok is regular");

//     }else{
//       console.log("not is regular");
//     }

//   }else{
//     console.log("education is not matched");

//   }

// }else{
//   console.log("city is not matched");
// }
...
// if(city=="karad" && dis=="satara" && country=="india"){
...
// var year = 2024;
// if(year % 4 == 0){
//   console.log("this is the leaf year" , year);


// }else{
//   console.log("this is not leaf year" , year);
...
//     }else{
//       console.log("The year  if  " + year + " is not a leap year");
//     }
//   }else{
//     console.log("The year " + year + " is a leap year");
//   }
...
// if(year % 4 === 0){
//   console.log("this is the leaf year ");
...
// if( year ){
//   console.log(" first if log ");


// if(){
//   console.log(" second if log ");

//  if(){
//   console.log(" 3rd if log ");
...
// sign up  ..// email mobile otp password 100 

// {
  // signup 
// }//
// class / function 
// login // email password  50 
// 
...
// function // parameters // return // arguments
...
// const a = 60;
// const b = 50;
// console.log("this is the :" + a + b + "kgjfdkg");
// console.log(`this is the result ${a + b } typing again ${a - b} kfjdkfj`);
...
// console.log(myBioData.function());
...
// const sum1 = () => `the sum of two numbers ${(a=5) + (b=6)}`
// console.log(sum());
...
// console.log(`all colors = ${MyFavColors}`);
...
// var langs = [ "html" , "css" , 30 , true , null , undefined ];
// console.log(langs[56]);
...
// var myFriends = ['vinod','ramesh','arjun','vishal' ,"raj"];
// console.log(myFriends[0]); // 4 
// console.log(myFriends.length-1); // 3
...
// myFriends.forEach(( ele, index , arrays )=>{

// })

// myFriends.forEach(function(element , index ,  arrays ){

//   // console.log(ele , arrs);
// console.log(` ${element} index : ${index} of ${arrays}`);
...
// products.forEach((ele, index, array) => {
//   console.log(element + " index : " +
//     index + " " + array);
// });
...
// var myFriendNames = ['vinod','ramesh','arjun','vishal'];
//  console.log(myFriendNames.indexOf('arjun'));
...
// var myFriendNames = ['vinod','ramesh','arjun','vishal','js'];
// console.log(myFriendNames.lastIndexOf("vinod" ));
// // console.log(myFriendNames.length);

// console.log(myFriendNames.lastIndexOf("arjun"));
...
// var mylangs = ["js", "java" , "php", "react"];
// console.log(mylangs.includes("js"));
...
// const result = prices.find((ele,index , arr)=>{
//   console.log(ele > 400);
...
// const result = prices.filter((ele , index, arr)=>{
//       console.log(ele < 400);
...
// find , includes , filter , search , sort  , forEach , Map 
...
// console.log(animals);
// const results = animals.push("cat")
// console.log(results);

// const newAnimals = animals.push( "cat" , "dogs");
...
// const newAnimals = animals.unshift("cat");
// console.log(newAnimals); // return the length 
...
// const langs = ["js", "java" , "react" , "node"];

// console.log(langs);
//   const newRemove = langs.pop(); // return node
...
// const months = [ "march","april" , "June" , "feb"];
...
// sol3: 
// const months = ['Jan', 'march', 'April', 'June', 'July', "feb"];

// const indexOfMonth = months.indexOf('June');

// if(indexOfMonth != -1){
//   const deleteMonth = months.splice(indexOfMonth,2);
//   console.log(months);
...
// let result = arr.map((curle , index , arrr)=>{
...
// function newsum (){
//   console.log(`other function ${sum}`);
// }
// newsum();
...
// let array1 =[4,6,9,16,49,81];
// let newArr = array1.map((curElm, index, arr) => {



// let array1 =[4,6,9,16,49,81]; 
// let newArrfor = array1.forEach((curElm, index, arr) =>   `Index no = ${index} and the value is ${curElm} belong to ${arr} `);
...
// const newArr = array1.map((curElm,index,arr)=>{
...
//  👉 // 🤩 SUBSCRIBE TO SHAHID TECHNICAL YOUTUBE CHANNEL 🤩
...
// let arr2 = arr.map((curElem)=> filter((curElem)=> curElem*2).curElem > 10).reduce(( accumulator , curElem  )=> {
//   return accumulator += curElem;
// })
// console.log(arr2);

// let arr2 = arr.map(( currlem , index , arr)=> currlem*2).filter((currlem , index , arr)=>currlem > 10).reduce(( accumulator,  currlem , index , arr)=>{
//   return accumulator += currlem;
...
// let sum = arr.reduce((accumulator, curElem , index , arrr ) => {
//         debugger;
//       return accumulator += curElem;
// },30)
// console.log(sum);
...
// const arrs = [ 1 ,2 , 3 , [4, 5 , 6 , [3 , 6, 7, 7]], ]
...
// I'm software deblover 


// let myName = "HTML JAVA";
// console.log(typeof(myName));

// let myVillageName = 'KARAD';

// let fName = new String("html");
// console.log(typeof(fName));
// let city = 'karad';
...
// const myBioData =  'I am the javascript developer';
...
// const myBioData =  'I am the javascript developer';
// let sData = myBioData.search("dev")
// console.log(sData);

// let sData = myBioData.search("javascript");
// console.log(sData);
...
// var fruits  = "Apple, Bananaa, Kiwi, mango";
// let res = fruits.substring(7,11);
// console.log(res);
// console.log(fruits);
...
// var fruits = "Apple, Bananaa, Kiwi";
// let res = fruits.substring(2,-10);
// console.log(res);
...
// let myBioData = `I am vinod bahadur SHAHID vinod`;
// var str = "Apple, Bananaa, Kiwi,Bananaa";
// let newData = str.replace("bananaa" , "mongo")
// console.log(newData);
...
// var str = "Apple, Bananaa, Kiwi";
// var res = str.replace("Apple" , "mongo");
// console.log(res);
...
// console.log(result);
// console.log( str.charCodeAt(result));
...
// var result = new Date("October 13, 2021 11:13:00");
// console.log(result.toLocaleString());
...
// alert(location.href); 
// if (confirm("Want to Visit blockchain?")) {
//   location.href = "https://www.youtube.com/watch?v=gyMwXuJrbJQ"; // redirect the browser to another URL
// }
